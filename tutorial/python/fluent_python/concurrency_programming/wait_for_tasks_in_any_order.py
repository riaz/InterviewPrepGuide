...
If it does not matter what order the results should be processed, use as_completed() to process 
them as each task finishes.
"""
...
for f in futures.as_completed(wait_for): # as completed over map can be used to schedule in order of completion
